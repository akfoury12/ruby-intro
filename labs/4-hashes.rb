...
puts "Currently it is #{weather_data[:current][:temperature]}. Tomorrow it will be #{weather_data[:forecast][0][:conditions]}"  
# puts "The next day we will see #{weather_data[:forecast]}"